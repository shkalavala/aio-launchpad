...
export const ROLLOUT_HISTORY: RolloutRecord[] = [
  ...
  // ── Infra-scope history (renders in the strip when manageInfra=true) ────
  {
    id: "ro-2026-06-02-01",
    kind: "aksee-upgrade",
    infraTargetVersion: "1.7.230",
    siteCount: 2,
    ringStrategy: "Canary → Wave 1",
    startedAt: "2026-06-02T06:00:00Z",
    finishedAt: "2026-06-02T07:42:00Z",
    outcome: "succeeded",
    note: "Three-cmdlet AKS-EE stage → cp → workers via Arc Run Command",
    triggeredBy: "you",
  },
  {
    id: "ro-2026-06-01-02",
    kind: "helm",
    helmLabel: "edge-control 3.2.0",
    siteCount: 1,
    ringStrategy: "Single ring",
    startedAt: "2026-06-01T14:10:00Z",
    finishedAt: "2026-06-01T14:21:00Z",
    outcome: "succeeded",
    note: "Helm chart upgrade via Arc Kubernetes proxy",
    triggeredBy: "you",
  },
];
